...
but the main reason I want to share this is that it's a very good first project to learn eBPF.
...
In order to fully understand what want to do, I believe it's useful to approach the
problem from first principles, which in this case means understanding how web servers work.
