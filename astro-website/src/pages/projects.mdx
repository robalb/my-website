...
There are several online assembly editors, but none of them has a gdb-like debugger interface and offers full control over
the assemblers being run, which is why I created my own.
...
where I taught binary exploitation in weekly training sessions.
