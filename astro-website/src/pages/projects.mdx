...
It went from being a php + vanilla js web app in 2018 to being a react+redux monstruosity in 2020, hosted
...
but knowing the time it took to properly prepare they didn't choose the victims randomly, admitting
