...
It's a website currently used by hundrends of users to share and write code snippets for popular assemblers like Fasm 
 Nasm or Gnu Binutils.
...
These charateristics and the limited size of the project
are the reason I use this website as a playground to test various web technologies.
We learn from our mistakes, and this is where I intentionally make my mistakes.

The website went from being a php + vanilla js web app in 2018 to being a react+redux monstruosity in 2021, 
